...
def read_all_emails_generator(M):
    ...
    for num in data[0].split():
        ...
        yield {'body': '\n'.join(body), 'subject': subject, 'local_date': local_date.strftime("%a, %d %b %Y %H:%M:%S"),
...
def main():
    ...
    if rv == 'OK':
        ...
        for msg in read_all_emails_generator(email_reader):
            resp = '{}, {}, \n\n {},\n\n{}'.format(get_greeting(msg['local_date']), msg['sender_name'],
                                                   answer_questions(msg), greeting_end)
