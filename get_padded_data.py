# changed the padding of paragraphs_ans & paragraphs_q by Ting
...
paragraphs_ans = [answers.split('\n')]
paragraphs_ans = ['BOS ' + p + ' EOS' for p in paragraphs_ans]
paragraphs_q = [questions.split('\n')]
paragraphs_q = ['BOS ' + p + ' EOS' for p in paragraphs_q]
tokenized_answers = [p.split() for p in paragraphs_ans]
